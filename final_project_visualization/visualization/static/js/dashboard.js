...
function dashboard(id, fData) {
    ...
    fData.forEach(function (d) {
        ...
        d.total = Object.keys(d.count).reduce((sum, key) => sum + d.count[key], 0);
    });
    ...
    function histoGram(fD) {
        ...
        bars.append("rect")
            .attr("x", /* TO FINISH */ function (d,i){
                return x(d[0]);
            })
            .attr("y", /* TO FINISH */ function (d,i){
                return y(d[1]);
            })
